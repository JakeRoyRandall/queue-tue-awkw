...
function fail(message) { failed = 1; print "error: " message > "/dev/stderr"; exit 2 }
{
    ...
    start = (next_free[lane] > ready ? next_free[lane] : ready)
